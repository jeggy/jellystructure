...
today, see §5).
```
Night Visitor (2023): eng "WEB-DL" | eng "SDH - UHD BluRay" | eng "SDH - BluRay"
Dark Woods Rising (2023): eng (no title) | eng "SDH"
```

### 3.2 Forced (foreign-dialogue-only) vs. full track, same language
```
Ruffy's Big Show: dan "Forced" (forced=true) | fin "Forced" (forced=true) | nor "Forced" (forced=true) | swe "Forced" (forced=true)
                  eng (no title) | eng "SDH"
Den sidste nordbo: dan "Danish Forced" (forced=true, default=true)
```
...
releases:
```
Butter Fingers: spa ×4 (no titles at all — dialects indistinguishable)
Beetlemania: spa "Castilian" | spa "Latin American"
         fre "Canadian" | fre "Parisian"
         por "Brazilian" | por "Iberian"
         chi "Simplified" | chi "Traditional"
Skyborn: Ember and Ash: eng (no title) | eng "SDH" | spa "Latin American"  (only one Spanish variant here)
The Groom!: spa "Spanish (Spain)" | spa "Spanish (Latin America)"
...
```
Ring the Lawyer S6E5 / S6E9: eng "PGS (Forced)" (forced) | eng "PGS" | eng "PGS (SDH)"
...
```
Enklaven S1E1-4: por "Portuguese (Brazil) [Forced]" (forced, default)
...
```
Night Visitor: eng "WEB-DL" | eng "SDH - UHD BluRay" | eng "SDH - BluRay"
...
```
40 Days Gone (2002) remux: 32× hdmv_pgs_subtitle, ALL language=null, ALL title=null
                             (only the first has default=true)
40 Years Gone (2025) remux: 9× hdmv_pgs_subtitle, ALL language=null, ALL title=null
40 Years Gone: The Ash Chapel: 13× hdmv_pgs_subtitle, ALL language=null, ALL title=null
```
...
system stores. The `40 Years Gone: The Ash Chapel` and untagged-PGS cases above are extreme
examples, but even ordinary titled releases hit this (e.g. `Butter Fingers`'s 4 untitled Spanish tracks,
