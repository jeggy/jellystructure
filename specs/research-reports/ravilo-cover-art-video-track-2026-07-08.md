...
**Question:** a user pressed play on *Silicon Valley* S01E01 on the stue TV and the media player
...
`Silicon.Valley.S01E01.1080p.MAX.Web-DL.[TR-EN].DDP5.1.H.264-TURG.mkv` (jellyfinId
...
- Silicon Valley S01E01 plays on the stue TV after the fix (verified: READY, advancing, no error).
