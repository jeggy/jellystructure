...
> Triggered by last night's report: *Till Daybreak (2025)* — a 2160p HEVC **REMUX**, Dolby Vision Profile
...
(designed and built 2026-08-28, the day after the *Spindlelegs* incident) already probe each device's real
...
Item: Till Daybreak | Path: …Till.Daybreak.2025.REPACK.UHD.BluRay.2160p…DV.HDR10P.HEVC.HYBRID.REMUX…mkv
...
- **Live, at render time:** Jellyfin's own `MediaSources[].MediaStreams[].BitRate` already carries this
  (confirmed live moments ago against both Strigoi and Till Daybreak — see §1's numbers) and jellystructure
