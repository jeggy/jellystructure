...
> 2026-08-20/21 a qBittorrent download was writing to `/mnt/series` while the Severance file was being
...
target **and** the cross-seed hardlink tree. The streamed Severance file has link count 2 — it is
