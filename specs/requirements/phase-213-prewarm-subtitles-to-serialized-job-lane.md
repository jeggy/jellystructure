...
2026-09-15, ~17:35 UTC. A viewer (`aleks`, BRAVIA 4K GB ATV3) was 30 minutes into *The Patriarch* when
...
Godfather was streaming from — *Dreadful Me 4* (32 subtitle tracks in one pass), *Night Visitor*,
*Ada Watson*, *Ada Watson 2*, *The Final Norseman*, *1931*, *The Rascals*, *Everything Everywhere All
...
item can hold many streams (32 on *Dreadful Me 4*), each costing a full-file read; a job that started
