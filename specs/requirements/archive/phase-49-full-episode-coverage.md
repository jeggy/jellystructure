...
**Status:** ✓ Done · _the library scan probes only a spread of 100 episodes for series with >100 files,
so long shows (e.g. "Three and a Half Uncles", ~260 episodes) show scattered gaps in the Seasons & Episodes
