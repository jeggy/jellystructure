...
`Items` array, confirmed against Fjollerne: 101, matching §1) — recorded here for FR-181-3 even though it
...
4. ~~FR-181-3 needs one bulk call for per-series episode counts…~~ **Answered, for the record, even
   ...
   returns `{"Items":[],"TotalRecordCount":N}` — confirmed live against Fjollerne (101, matching §1) — not
