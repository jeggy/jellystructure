...
```
/mnt/media/jellyfin/movies/Three Thieves and a Bear (2022)/clearlogo.png
...
/mnt/series/jellyfin/Cooking Trouble/clearlogo.png
...
TMDB's `logos` array mixes PNG and SVG (`/…/images`, confirmed live: Cooking Trouble 39 logos of which 3
...
2. Run FR-192-2's sweep: the Cooking Trouble and *Three Thieves and a Bear* files are removed, both items
   get a History entry, and a subsequent artwork fetch downloads real logos.
3. Save Cooking Trouble's SVG candidate: `clearlogo.png` starts with `\x89PNG`, opens in an image viewer,
...
6. Open the Artwork tab → Clearlogo on Cooking Trouble: every tile shows a complete, readable wordmark;
