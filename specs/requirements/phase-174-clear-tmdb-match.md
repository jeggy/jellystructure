...
> Reported live: the music video **"Tina Varde - Lowtide"** was auto-matched to an unrelated **1923
...
- `scripts/check-mobile-css.sh` — OK (no new CSS rule needed; both new buttons reuse the existing
  `.btn.bad` class).
- Not yet live-tested against the reported "Tina Varde - Lowtide" item, and neither UI affordance has
