...
> Reported live, same session as Phase 171/172: a screenshot of `Eivør_Christmas_Show_Download (2020)`'s
...
Confirmed the file is real and correctly placed: `/mnt/media/jellyfin/music/Eivør/
Eivør_Christmas_Show_Download-poster.jpg` exists on disk under the exact `<basename>-poster.jpg`
...
- Confirmed on disk directly: `Eivør_Christmas_Show_Download-poster.jpg` exists at the exact path
...
- **A second, separate, wider bug surfaced by the same investigation**: `item.posterPath` — the field
  ...
  Eivør case too. So even after this fix made the Artwork tab correctly show the asset, the **Library
