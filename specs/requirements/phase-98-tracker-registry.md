...
```
https://t.polarswarm.org/announce/a1b2c3d4e5f607181ba7ef0066619d3e
https://t.nordicswarm.org/announce/a1b2c3d4e5f607181ba7ef0066619d3e
https://t.nordicvault.org/announce/a1b2c3d4e5f607181ba7ef0066619d3e
```
...
several rows. There's no place to say "these hosts are all *FrostSeed*".
...
name = "FrostSeed"
private = true
hosts = ["t.nordicswarm.org", "t.polarswarm.org", "t.nordicvault.org"]
```
...
## Design reference
- `design/app/metadata.html` — the **Trackers** tab: FrostSeed (3 mirror hosts, add-host), FilmBytes
