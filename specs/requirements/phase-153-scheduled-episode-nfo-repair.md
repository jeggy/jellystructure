...
**Status:** Implemented. Takes effect on the next scheduled run for any affected series (e.g. Stormester) —
...
(Stormester S10E07 `1ba13ecc…`, Tabu S04E06, X Factor S19E21/E22, Operation X S2026E01/E02, Jo færre jo
bedre S09E02, Gud signi Føroyar S01E01 — all non-null). The defect is **not** "jellystructure couldn't
...
- It is **not** the file: `ffprobe` reads S10E07 cleanly (valid Matroska, 59:17, H264/AAC/subrip, decodes
  without error). It is **not** the filename pattern: `Stormester.S10E01…` and `…S10E08…` are
...
3. Verified via `compileKotlinLinuxX64`, `linuxX64Test` (full suite passes — FR-SCAN2-1's carry-forward
   ...
   Jellyfin re-reads) is code-verified end-to-end but not yet observed live for Stormester specifically.
