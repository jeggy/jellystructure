...
> Live-hit tonight (2026-08-28): playing `Longlegs` (65 GB remux) on stue TV, ~90 s into playback, its
...
3. **Phase 177** (shipped today, same session as this report) makes `needsTranscode` true far more often
   ...
   before it would have (incorrectly, silently-broken) direct-played. Longlegs (93 Mbps HEVC, exceeds
