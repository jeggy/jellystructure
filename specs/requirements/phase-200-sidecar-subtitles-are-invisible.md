...
### Confirmed end to end — *28 Days Later*
...
|---|---|---|---|
| Modern Family | 251 | `eng` | 20 more, incl. `dan` `swe` `nor` `fin` |
| Bluey | 153 | 9 languages | 11 more, incl. `dan` `nor` `swe` |
| Two and a Half Men | 262 | `eng` | `hin` `tam` `tel` |
| Sært tú fuglin? | 9 | *nothing* | `fao` |
...
folder (`Gud signi Føroyar S01E01.mkv` sitting beside `…S01E05.fo.srt`). A looser match would
...
- **Fixing untagged embedded tracks.** *28 Days Later*'s 32 untagged embedded streams are a real
