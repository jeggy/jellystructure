...
**Planned backlog 38–40** — a batch of operator-ergonomics + trust features, each with a spec and an
...
Phases 0–37 complete. See [`requirements/README.md`](requirements/README.md) for the full index.
