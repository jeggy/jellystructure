...
> Klågere end du tror should be there." Root-caused live: jellystructure asks Jellyfin for the **global**
...
- Live numbers for this user: **NextUp `TotalRecordCount: 54`** (we fetch 20) and **115 resumable items**
  (we fetch 20). **"Klågere end du tror" sits at position 41 of 54** — well outside the window, so it never
