...
> pressed play, but Jellyfin recorded no position. Nine were 6 weeks to 6 months old (Pokémon: 1 of
> 1128 episodes; Pettersson and Findus: February). One — *The Bombing of Pan Am 103* — was **3 days
...
|---|---|---|---|---|
| **Vi drukner i rod** | S5E1, Jul 7 | *(none)* | resume S5E1 | ✓ resume |
| **Mumi** | S1E26, Jul 9 | Aug 1 | **next-up** | ✗ showed 3-week-stale S1E26 |

`/Shows/NextUp` is not trustworthy on its own — for Vi drukner i rod it suggested **S1E1 of a series
...
- for a title with several in-progress episodes, the **most recent** one is the resume candidate
  (this already works, and is why Teletubbies correctly shows S1E5/88% and not its stale S1E3);
...
| Next-up suggests **S1E1** while real progress is deeper | Resume wins *if newer* — the Vi drukner i rod case. |
| Stale resume, newer finish | Next-up wins — the Mumi case. |
