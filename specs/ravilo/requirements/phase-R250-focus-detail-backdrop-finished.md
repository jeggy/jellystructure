...
> the answer came back on 2026-09-16 from the stue TV: not enough. Over *The Curse of Oak Island* and
> *Tomgang* the panel's synopsis sits on bright, high-frequency picture and reads badly at sofa
...
- *The Curse of Oak Island* — synopsis in `textSecondary` grey over sunlit forest; genre chips
...
- *Tomgang* — the synopsis runs across the backdrop's own TOMGANG sign; `"…tvinger det ham t…"` is
  ellipsised at the screen's right edge.

From the semantics tree in the *Tomgang* frame (px, 1920-wide):
...
**FR-R250-7 — Verified on the device that produced the frames.** *The Curse of Oak Island*, *Tomgang*,
