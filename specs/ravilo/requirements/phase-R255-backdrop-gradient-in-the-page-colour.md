...
R250 named — *The Riddle of Pine Isle* and *Frigear* (Continue Watching, LANDSCAPE), one POSTER-row
...
1. Stue TV, Aurora, J open on *The Riddle of Pine Isle*: the forest is visibly a forest across the
...
2. Same on *Frigear* (bright sign behind the text) and on a POSTER-row title (a narrower tile, a
   wider panel).
