...
|---|---|---|---|
| Tomgang (LANDSCAPE, a sunlit shop front) | R250 box | 0.021 | 7.1:1 |
| | first R255 gradient (40 % feather) | — | **2.4:1** 150 px into the text — failed |
| | **flat 0.75** | 0.051 | **5.0:1** |
| The End of Oak Street (POSTER) | R250 box | 0.007 | 8.9:1 |
| | **flat 0.75** | 0.022 | **7.1:1** |

The title clears 10:1 in every frame. Not measured: a Noir pass and *The Curse of Oak Island*.
