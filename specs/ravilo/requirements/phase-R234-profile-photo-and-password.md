...
- **R233's fix, confirmed against the exact live report that opened that phase**: standing inside
  Thriller / Gyser, Continue Watching showed only thriller/horror titles (Strigoi, Shower Scene, Speed
  Demon, Monkey's Magic Merry-Go-Round…) — not the *Three and a Half Uncles*/*Fjollerne*/*Ace K* mix the original
