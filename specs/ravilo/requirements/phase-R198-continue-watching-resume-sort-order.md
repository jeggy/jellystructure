...
> A viewer on stue TV reported *Offboarding* (watched today) sitting behind *Moula* (last watched four
...
> viewer confirmed Offboarding still shows a progress bar (i.e. it's genuinely in the resumable set, not
...
## Bug report
"why is severnce behind moula in the contonie watching section on stue tv? i did watch offboarding today
but not moula." Clarified once asked whether Offboarding had finished an episode (which would make it a
next-up entry instead of resumable): "i did not actually finish an episode in offboarding, and can see in
...
- **Not a resume/next-up concatenation bug** — `buildContinueRow` places all `resumeItems` cards before
  ...
  explain a just-finished title landing at the row's tail — but the viewer confirmed Offboarding still
...
```
9.  Sóley og Gás – Hyggja at mánanum   2026-08-16T09:16:50Z
10. Moula – Cheer Up Donkey               2026-08-14T16:17:47Z   ← out of order
11. Offboarding S02E03 – Who Is Alive      2026-08-17T18:02:05Z   ← out of order
12. NEPHEW – 07.07.07                    2026-08-13T21:00:03Z
```

Offboarding's real `LastPlayedDate` (2026-08-17, i.e. "yesterday" relative to the 2026-08-18 report — the
...
remembering but not the bug here) is later than Moula's (2026-08-14), yet Jellyfin placed Moula first
...
- The resume/next-up concatenation (`HomeFeedService.kt:511-539` places all resumable cards ahead of all
  ...
  `resumeItems` on a shared key. Not what this report turned out to be (Offboarding never left the
