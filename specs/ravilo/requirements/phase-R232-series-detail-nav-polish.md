...
D-pad edge-case sweep across the app. Reproduced and fixed three real bugs, all on Klovn (11
...
mid-animation) on Klovn. Fix: the same inset already defined for this screen's BringIntoView spec
...
Live-tested on stue TV against Klovn (S1: 9/10 watched, S2–S11 fully watched — the exact
