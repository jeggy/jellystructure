...
> switching between seasons in the series details page within Ravilo. One example is Politijagt."* and
...
> using Politijagt (34/35 seasons in the library) and screenshots at every step; see the investigation
...
`BRAVIA 4K VH21` (stue TV, `10.10.11.128`) and `BRAVIA 4K VH2` (`10.10.11.20`, the household's second TV,
