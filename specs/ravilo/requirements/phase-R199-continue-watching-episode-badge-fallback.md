...
> Watching shows its "S1 · E3"-style badge except *Offboarding*, whose S02E03 card has no episode number
...
## Bug report
"please take a look on stue tv. currently other series do show episode number, but not offboarding."
...
Offboarding's current resume entry ("Offboarding.S02E03.Who.Is.Alive") comes back with
...
`ParentIndexNumber`): "Fristelsens.Ø.Danmark.S01E01.NORDiC" and
"Happy.Tree.Friends.S01E01.The.Wrong.Side.of.the.Tracks...". By contrast, Offboarding's Season 1 files
(`Offboarding (2022) S01E01 (2160p...) [REPACK].mkv` — a bracketed, non-dotted naming convention) all parse
fine in Jellyfin.
