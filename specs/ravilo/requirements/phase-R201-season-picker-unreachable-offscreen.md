...
> to pick the correct season" — named `Fjollerne` (11 seasons, fully watched) as a repeat offender.
> Live-reproduced on stue TV via adb: from Fjollerne's Play/My List buttons, pressing Down never lands
...
correct season for a series... I know I've seen this a few times for the 'Fjollerne' series." (2026-08-18.)

## Investigation
Live-reproduced on stue TV: opened Fjollerne (11 seasons, "99 of 99 episodes watched"), Play had focus by
...
`seasons.size - 1` — **the last season**. For Fjollerne that's Season 11, index 10.
...
Fjollerne (11 seasons, binge-completed) is simply the easiest case to hit by accident.
