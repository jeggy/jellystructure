...
> Live report (stue TV): *"Very often (example in 'Kulsort' S07E03) there is no subtitles, but when
...
`kulsort-2019`, S07E03 (*Hygge*),
`Kulsort.S07E03.DANiSH.1080p.WEB.h264-STROMPEBUKSER.mkv` — its tracks as scanned:
...
Spread across Danish TV (*Kulsort*, *Efterforskningen*), Marvel releases, Netflix rips and more — this is
...
1. Stue TV, *Kulsort* S07E03, with no prior Danish memory for the series: subtitles appear on screen
