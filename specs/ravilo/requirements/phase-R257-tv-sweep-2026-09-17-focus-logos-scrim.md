...
On *Tomgang* the app bar, the facts and the synopsis sit on a sunlit shop front. The detail hero has a
...
3. Tomgang's detail page: nav, facts and synopsis legible; the picture still clearly visible right of
   centre.
