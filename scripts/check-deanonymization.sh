...
BANNED=(
  "jebster.net|real household domain (anonymized to example.net)"
  "NordicHD|real private tracker name (anonymized to FrostSeed)"
  "NordicBytes|real private tracker name (anonymized to NordicVault)"
  "0021b118ead08ed4|real (if-still-valid) tracker announce passkey"
  "10.0.0.10|real household IP (anonymized to 192.0.2.10)"
  "10.0.0.11|real household IP (anonymized to 192.0.2.11)"
  "10.0.0.12|real household IP (anonymized to 192.0.2.12)"
  "10.10.10.10|real backend host IP"
  "10.10.11.128|real stue-TV IP"
  "10.10.11.20|real soveværelse-TV IP"
)
