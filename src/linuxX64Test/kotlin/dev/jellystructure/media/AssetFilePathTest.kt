...
class AssetFilePathTest {
    ...
    fun `music video poster uses the video's own basename since siblings share the folder`() {
        val path = assetFilePath(
            item(MediaKind.MUSIC_VIDEO, "/mnt/music/Ranvá/Ranvá - Live in Bergen (2026-08-04).mkv"),
            "poster.jpg",
        )
        assertEquals("/mnt/music/Ranvá/Ranvá - Live in Bergen (2026-08-04)-poster.jpg", path)
    }
}
