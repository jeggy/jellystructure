 ...
 * path now calls; the case that reproduces the live report (`tenfold-2003`, override "en", library audio
...
class MetadataLanguageOverrideTest {
    ...
    fun `override moves to the front of the audio-derived priority list`() {
        // tenfold-2003's shape: Korean audio drives the base priority, but the operator set English.
