...
// Phase 217 (FR-217-1) — the sidebar is BASE_NAV and nothing else. The phase-162 group that used to be
// appended behind a localStorage flag is deleted, not gated: no code reads that key any more, so a
// browser still holding the stale key gets exactly this list.
private fun navEntries(): List<NavEntry> = BASE_NAV
