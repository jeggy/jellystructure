 ...
 *
 * Verified in a real library: the whole `Tellytots.S01…` release folder had been extracted a second
...
object DuplicateEpisodes {
     ...
     * nested re-extraction lose to the original — `…/Tellytots.S01…/…` sorts before
     * `…/Tellytots.S02…/Tellytots.S01…/…`.
     */
