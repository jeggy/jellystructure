...
fun Route.configureConfigRoutes(
    ...
    put("/config") {
        ...
        var config = received.copy(scan = received.scan.copy(fileCheckStepsSeeded = stored.scan.fileCheckStepsSeeded, recommendationsStepSeeded = stored.scan.recommendationsStepSeeded))
