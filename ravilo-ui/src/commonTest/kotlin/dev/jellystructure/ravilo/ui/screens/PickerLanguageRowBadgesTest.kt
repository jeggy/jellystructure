 ...
 * always returned the FIRST version in stream order. On the real `Helt.Sort.S07E03` that meant a
...
class PickerLanguageRowBadgesTest {
    ...
    /** The exact shape of Helt Sort S07E03: forced+default first in stream order, full track second. */
