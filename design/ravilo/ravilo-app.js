  ...
  function mountRavilo(stage, opts) {
    ...
    function tracksFor(item) {
      ...
      if (isBBB(item)) return {
        audio: [
          { label: 'English', lang: 'en', fmt: 'Stereo', def: true },
          { label: "Director's commentary", kind: 'commentary', fmt: 'Stereo' },
          { label: 'Føroyskt', lang: 'fo', fmt: 'Surround 5.1', note: 'Dubbed' },
          { label: 'Dansk', lang: 'da', fmt: 'Surround 5.1', note: 'Dubbed' },
          { label: 'Deutsch', lang: 'de', fmt: 'Surround 5.1', note: 'Dubbed' },
          { label: 'Español', lang: 'es', fmt: 'Stereo', note: 'Dubbed' },
          { label: 'Français', lang: 'fr', fmt: 'Stereo', note: 'Dubbed' },
          { label: 'Italiano', lang: 'it', fmt: 'Stereo', note: 'Dubbed' },
          { label: 'Nederlands', lang: 'nl', fmt: 'Stereo', note: 'Dubbed' },
          { label: 'Português', lang: 'pt', fmt: 'Stereo', note: 'Dubbed' },
        ],
        subs: [
          { label: 'Off', off: true },
          { label: 'English', lang: 'en' },
          { label: 'English', lang: 'en', kind: 'sdh' },
      ...
      return {
        audio: [
          { label: 'Føroyskt', lang: 'fo', fmt: 'Surround 5.1', def: true },
          { label: 'Dansk', lang: 'da', fmt: 'Surround 5.1', note: 'Dubbed' },
          { label: 'Dansk', lang: 'da', fmt: 'Surround 5.1', kind: 'describe' },
          { label: 'English', lang: 'en', fmt: 'Stereo', note: 'Dubbed' },
          { label: "Director's commentary", kind: 'commentary', fmt: 'Stereo' },
        ],
        subs: [
          { label: 'Off', off: true },
          { label: 'Føroyskt', lang: 'fo' },
          { label: 'Dansk', lang: 'da' },
          { label: 'Dansk', lang: 'da', kind: 'forced' },
          { label: 'English', lang: 'en' },
          { label: 'English', lang: 'en', kind: 'sdh' },
          { label: 'English', lang: 'en', kind: 'commentary' },
          { label: 'Português', lang: 'pt', sub: 'Brasil', region: 'br' },
          { label: 'Português', lang: 'pt', sub: 'Brasil', region: 'br', kind: 'forced' },
          { label: 'Português', lang: 'pt', sub: 'Portugal', region: 'pt' },
          { label: '中文', lang: 'zh', sub: '简体', region: 'cn' },
          { label: '中文', lang: 'zh', sub: '繁體', region: 'tw' },
