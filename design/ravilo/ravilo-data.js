...
(function () {
  ...
  const pool = {
    ...
    comedy: ['Johnny Bravo','Klovn i Nord','Sommerhus & Sild','Naboer','Fars Ferie','Den Gode Nabo','Tøris','Kaffepause','Bryllupsballaden','Hytteliv','Strandvask'],
  ...
  const SYN = {
    ...
    'Klovn i Nord': 'Two friends take a fishing holiday in the far north and manage to insult an entire village before the boat leaves the pier.',
    'Klovn í Nord': 'Two friends take a fishing holiday in the far north and manage to insult an entire village before the boat leaves the pier.',
  ...
  const ABOUT = {
    ...
    'Klovn í Nord':    { director: 'Mikkel Nørgaard', network: 'Dansk TV', country: 'Denmark', lang: 'Danish', runtime: 28 },
  };
