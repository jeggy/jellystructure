...
(function () {
  const STR = {
    en: {
      ...
      br_audio: 'Audio', br_channel: 'Channel', br_quality: 'Quality', br_sort: 'Sort', br_titles: 'titles', br_person: 'Cast or crew',
      ...
      br_seerr_more: 'More with {name} · request on Seerr',
    ...
    da: {
      ...
      br_seerr_more: 'Mere med {name} · anmod på Seerr',
    ...
    fo: {
      ...
      br_seerr_more: 'Meira við {name} · bið á Seerr',
