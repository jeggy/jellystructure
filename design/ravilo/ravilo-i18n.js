...
(function () {
  const STR = {
    en: {
      ...
      channels: 'Collections', channels_sub: 'Configured in Jellystructure',
      more_like_this: 'More Like This', back_home: 'Home', channel: 'Collection',
      channel_sub: 'The same rows you love, filtered to {name}. Continue watching, newly added, and every genre — scoped to this collection.',
    ...
    da: {
      ...
      channels: 'Samlinger', channels_sub: 'Konfigureret i Jellystructure',
      more_like_this: 'Mere som dette', back_home: 'Hjem', channel: 'Samling',
      channel_sub: 'De samme r\u00e6kker, filtreret til {name}. Forts\u00e6t med at se, nyligt tilf\u00f8jet og alle genrer — afgr\u00e6nset til denne samling.',
    ...
    fo: {
      ...
      channels: 'Savn', channels_sub: 'Sett upp \u00ed Jellystructure',
      more_like_this: 'Meira sum hetta', back_home: 'Heim', channel: 'Savn',
      channel_sub: 'Somu r\u00f8\u00f0irnar, sila\u00f0ar til {name}. Hald fram, n\u00fdtt og allir sjangrar — avmarka\u00f0 til hetta savni\u00f0.',
