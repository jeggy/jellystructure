...
(function () {
  const STR = {
    en: {
      ...
      br_genre: 'Genre', br_type: 'Type', br_maturity: 'Maturity', br_year: 'Year', br_watched: 'Watched',
      br_audio: 'Audio', br_channel: 'Channel', br_quality: 'Quality', br_sort: 'Sort', br_titles: 'titles',
      br_s_added: 'Recently added', br_s_year: 'Release year', br_s_maturity: 'Maturity', br_s_imdb: 'IMDb rating',
      br_reset: 'Reset filters', br_pick_any: 'pick any', br_from_row: 'From “{row}”',
      br_w_unwatched: 'Unwatched', br_w_inprogress: 'In progress', br_w_watched: 'Watched',
      br_t_film: 'Film', br_t_series: 'Series',
    ...
    da: {
      ...
      br_audio: 'Lyd', br_channel: 'Kanal', br_quality: 'Kvalitet', br_sort: 'Sortér', br_titles: 'titler',
      br_s_added: 'Senest tilføjet', br_s_year: 'Udgivelsesår', br_s_maturity: 'Aldersgrænse', br_s_imdb: 'IMDb-bedømmelse',
      br_reset: 'Nulstil filtre', br_pick_any: 'vælg frit', br_from_row: 'Fra “{row}”',
      br_w_unwatched: 'Ikke set', br_w_inprogress: 'I gang', br_w_watched: 'Set',
      br_t_film: 'Film', br_t_series: 'Serie',
      br_from: 'Fra', br_to: 'Op til', br_any: 'Alle', br_range_hint: '◂ ▸ justér · OK færdig',
    ...
    fo: {
      ...
      br_audio: 'Ljóð', br_channel: 'Rás', br_quality: 'Góðska', br_sort: 'Raða', br_titles: 'heiti',
      br_s_added: 'Nýliga lagt afturat', br_s_year: 'Útgávuár', br_s_maturity: 'Aldursmark', br_s_imdb: 'IMDb-meting',
      br_reset: 'Strika filtur', br_pick_any: 'vel frítt', br_from_row: 'Úr “{row}”',
      br_w_unwatched: 'Ikki sætt', br_w_inprogress: 'Í gongd', br_w_watched: 'Sætt',
      br_t_film: 'Filmur', br_t_series: 'Røð',
      br_from: 'Frá', br_to: 'Upp til', br_any: 'Øll', br_range_hint: '◂ ▸ broyt · OK liðugt',
