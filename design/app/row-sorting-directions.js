...
(function(){
  ...
  const TITLES=[
    T('Klovn',2005,2,'series','dk'), T('Borgen',2010,40,'series','dk'), T('The Godfather',1972,120,'movie','us','Godfather'),
    T('Severance',2022,5,'series','us'), T('Trom',2022,9,'series','fo'), T('Riget',1994,300,'series','dk'),
    ...
    T('Forbrydelsen',2007,250,'series','dk'), T('Anatomy of a Fall',2023,22,'movie','fr'), T('Herrens Veje',2017,130,'series','dk'),
  ...
  const PINS=['Trom','Klovn','Severance','Badehotellet','Borgen'];
  ...
  (function(){
    ...
    const pins=pinned(['Trom','Klovn','Druk','Badehotellet']);
