...
(function () {
  ...
  const I = {
    ...
    triage:    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"><path d="M12 4 21 19H3z"/><line x1="12" y1="10" x2="12" y2="14" stroke-linecap="round"/><circle cx="12" cy="16.6" r="0.4" fill="currentColor" stroke="none"/></svg>',
    ...
    language:  '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7"><circle cx="12" cy="12" r="8.5"/><line x1="3.5" y1="12" x2="20.5" y2="12"/><path d="M12 3.5c2.6 2.4 2.6 14.6 0 17M12 3.5c-2.6 2.4-2.6 14.6 0 17" stroke-linecap="round"/></svg>',
